...
const faqs = [
  {
    question: 'What is 101.school?',
    answer:
      '101.school is an experiment in creating AI-generated course content. You enter a subject you are curious about, and our system generates an entire course on it using GPT-4.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '101.school is inspired by the work of Alex MacCaw and built as an experimental platform to push the boundaries of AI-driven education.',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-16">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-4">
            At 101.school, we believe learning is not just about consuming content—it’s about connecting, sharing knowledge, and building a community of lifelong learners.
          </p>
