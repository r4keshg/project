...
// External UI Components (assumed available)
// You can replace these with standard HTML elements if desired.
...
import { 
  ...
  MessageSquare, ThumbsUp, BookmarkPlus, Shield, Hash, ThumbsDown, 
  Reply, Share, MoreHorizontal 
} from 'lucide-react';

// Dialogs and Cards (assumed available)
...
// ------------------------------
const DetailedPostView = ({ post, onBack }) => {
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <CardDescription className="flex items-center mt-2">
                ...
                <Link to={`/clan/${post.clanId}`} className="flex items-center text-sm" style={{ color: '#2563eb' }}>
...
const MergedTribeAndPostPage = () => {
  ...
  function handlePostClick(post: React.SetStateAction<null>) {
